        ...
        <div class="table-box col-lg second-section" >
            ...
            <div>
                <div>
                    <div>
                        ...
                        <div class="input-group mb-3">
                            ...
                            <span class="input-group-text">조력자 분류</span>
                            <input type="text" class="form-control" aria-label="Text input with segmented dropdown button" >

                            <span class="input-group-text">평정기준표 점수</span>
                            <input type="text" class="form-control" aria-label="Text input with segmented dropdown button">
                ...
                <div class="notice-regi-btn">
                    ...
                    <button class="btn btn-outline-secondary" type="button" id="inputGroupFileAddon04" onclick="location.href='<c:url value="/slctn/slctnDetail"/>'">취소</button>
