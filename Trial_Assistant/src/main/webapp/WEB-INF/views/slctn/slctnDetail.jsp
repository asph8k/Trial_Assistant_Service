        ...
        <div class="table-box col-lg second-section" >
            ...
            <div>
                ...
                <div class="notice-regi-btn">
                    ...
                    <button class="btn btn-outline-secondary" type="button" id="inputGroupFileAddon04" onclick="location.href='<c:url value="/slctn/slctnUpdate"/>'">수정</button>
                </div>
